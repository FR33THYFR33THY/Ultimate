...
Get-FileFromWeb -URL "https://github.com/FR33THYFR33THY/files/raw/main/MSI Afterburner.exe" -File "$env:SystemRoot\Temp\MSI Afterburner.exe"

# install msi afterburner
Start-Process -wait "$env:SystemRoot\Temp\MSI Afterburner.exe" -ArgumentList "/S"
